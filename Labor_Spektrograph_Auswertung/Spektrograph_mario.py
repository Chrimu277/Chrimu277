...
def Disp_R(px):
    return (2.0e-7)*px**2 - 0.0147*px + 682.22
...
steps = [7,10,10,10,10,10,10,10,10,10,10,10,10,10,10]
imgs_ref = []
imgs_hal = []
...
path_hal = "C:/Bachelorstudium Physik Graz/6. Sem/FL Labor/Spektrograph/2020_06_18/Halogen_05"
...
path_ref = "C:/Bachelorstudium Physik Graz/6. Sem/FL Labor/Spektrograph/2020_06_18/Referenz"
valid_images = [".jpg",".gif",".png",".tga"]
...
for i in range(10):
    if i == 5:
        min = 12000+i*200+50+np.argmin(inten_vector_hal[12000+i*200+50:12000+(i+1)*200+50])
    else:
        min = 12000 + i * 200 + np.argmin(inten_vector_hal[12000 + i * 200:12000 + (i + 1) * 200])
    #print min
